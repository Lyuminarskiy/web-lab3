...
/**
 * Методы получения данных из базы данных.
...
module.exports = {
  ...
  comments: {
    ...
    /**
     * Отправляет клиенту продукт, для которого был написан указанный
    ...
    /**
     * Отправляет клиенту все ответы на комментарий с указанным
     * идентификатором.
     *
     * @param {Request} request - Объект запроса клиента.
     * @param {Response} response - Объект ответа сервера.
